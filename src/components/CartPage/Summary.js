    ...
    return (
        ...
        <div className="py-14 px-4 md:px-6 2xl:px-20 2xl:container 2xl:mx-auto">
            <div className="flex justify-start item-start space-y-2 flex-col ">
                <h1 className="text-3xl lg:text-4xl font-semibold leading-7 lg:leading-9  text-gray-800">장바구니</h1>
            </div>
                ...
                <div className="flex flex-col justify-start items-start w-full space-y-4 md:space-y-6 xl:space-y-8">
                          ...
                          return (
                            ...
                            <div className="border-b border-gray-200 md:flex-row flex-col flex justify-between items-start w-full pb-8 space-y-4 md:space-y-0">
                                <div className="w-full md:w-52 flex flex-col justify-start items-start space-y-8 ">
                                    ...
                                    <div className="flex justify-start items-start flex-col space-y-2">
                                        <p className="text-sm leading-none text-gray-800">
                                            <span className="text-gray-300">무게: </span> {item.weight}kg
                                        </p>
                                        <p className="text-sm leading-none text-gray-800">
                                            <span className="text-gray-300">종류: </span> {item.category}
                                        </p>
                                        <p className="text-sm leading-none text-gray-800">
                                            <span className="text-gray-300">형태: </span> {item.form}
                                        </p>
                                    </div>
                                </div>
                                <div className="flex justify-between space-x-8 items-start w-full">
                                    ...
                                    <p className="text-base xl:text-lg font-semibold leading-6 text-gray-800">{item.price * item.quantity}원</p>
                    ...
                    <div className="flex justify-center md:flex-row flex-col items-stretch w-full space-y-4 md:space-y-0 md:space-x-6 xl:space-x-8">
                        <div className="flex flex-col px-4 py-6 md:p-6 xl:p-8 w-full bg-gray-50 space-y-6   ">
                            <h3 className="text-xl font-semibold leading-5 text-gray-800">주문금액</h3>
                            <div className="flex justify-center items-center w-full space-y-4 flex-col border-gray-200 border-b pb-4">
                                <div className="flex justify-between  w-full">
                                    <p className="text-base leading-4 text-gray-800">상품가격</p>
                                    <p className="text-base leading-4 text-gray-600">{productPrice}원</p>
                                </div>
           
                                <div className="flex justify-between items-center w-full">
                                    <p className="text-base leading-4 text-gray-800">배송비</p>
                                    <p className="text-base leading-4 text-gray-600">5000원</p>
                                </div>
                            </div>
                            <div className="flex justify-between items-center w-full">
                                <p className="text-base font-semibold leading-4 text-gray-800">총 주문가격</p>
                                <p className="text-base font-semibold leading-4 text-gray-600">{productPrice+5000}원</p>
                            </div>
                        </div>
                        <div className="flex flex-col justify-center px-4 py-6 md:p-6 xl:p-8 w-full bg-gray-50 space-y-6   ">
                            <h3 className="text-xl font-semibold leading-5 text-gray-800">[비로그인] 비회원 주문 서비스만 제공합니다</h3>
